    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50">
      ...
      <main className="mx-auto max-w-7xl px-4 py-6 sm:px-6 sm:py-12 lg:px-8">
        ...
        <div className="mb-8 grid gap-6 sm:mb-12 lg:grid-cols-3">
          ...
          {/* Mode Latihan Card */}
          <div className="group relative overflow-hidden rounded-2xl border border-zinc-200 bg-gradient-to-br from-green-50 to-emerald-50 p-6 shadow-lg transition-all hover:shadow-xl dark:border-zinc-800 dark:from-green-950 dark:to-emerald-950 sm:p-8">
            <div className="absolute right-0 top-0 h-32 w-32 translate-x-8 -translate-y-8 rounded-full bg-green-200 opacity-20 dark:bg-green-800"></div>
            <div className="relative">
